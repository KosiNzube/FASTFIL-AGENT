    ...
    return MultiProvider(
      ...
      providers: [
        StreamProvider.value(
            value: StudentService(uid: message.student).userData, initialData: null
        )
      ],
      ...
      child: InkWell(
        ...
        child: Stack(
          children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                                brewx!.name,textAlign: TextAlign.center,style:GoogleFonts.nunito(
                            ...
                            Text(
                               message.content,textAlign: TextAlign.center,style:GoogleFonts.nunito(
            ...
            message.agentsender==false?message.sent==false? Positioned(right: 12, top: 12, child: Container(
              height: 12,
              width: 12,
              decoration: BoxDecoration(
            ...
            Positioned(right: 12, bottom: 8, child:Text(DateFormat('HH:mm').format(message.timestamp.toDate())),),
