...
class messageDatabase {
  ...
  Future<void> addMessage(String agentid,String student,String agentname, String text, String type, bool sent, Timestamp timestamp,bool xy) {
    ...
    return _reference.add({
     ...
     DocumentSnapshot documentSnapshot=await _reference.doc(value.id).get();
      ...
      if(documentSnapshot.exists){
        ...
        if(snt==false){
          print("notseen");
          sendMessageToTopic(student, agentname, text);
