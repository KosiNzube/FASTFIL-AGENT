...
Stream<List<Message>> get getMsgs{
   ...
   return FirebaseFirestore.instance.collection("Messages").where("agent",isEqualTo: firebaseAuth.currentUser!.uid).orderBy('timestamp',descending: true)  .snapshots().map(items);
}
